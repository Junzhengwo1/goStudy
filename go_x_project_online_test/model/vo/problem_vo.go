...
type ProblemVo struct {
	...
	ProblemCategories []*pojo.ProblemCategory `gorm:"foreignKey:problem_id;references:id" json:"problemCategories"`      // 关联问题分类表
	...
	TestCases         []*pojo.TestCase        `gorm:"foreignKey:problem_identity;references:identity;" json:"testCases"` // 关联测试用例表
