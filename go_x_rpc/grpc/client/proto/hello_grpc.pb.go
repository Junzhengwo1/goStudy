...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloRequest) (*HelloResp, error) {
